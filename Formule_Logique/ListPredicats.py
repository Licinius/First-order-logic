...
class ListPredicats(object): 
    ...
    dic = {
     ...
     "triangles_1" : Predicat("triangles",arite=1,fun=triangleFunc),
     "carre_1" : Predicat("carre",arite=1,fun=squareFunc),
    "carres_1" : Predicat("carres",arite=1,fun=squareFunc),
     "rond_1" : Predicat("rond",arite=1,fun=circleFunc),
     "ronds_1" : Predicat("ronds",arite=1,fun=circleFunc),
    "circle_1" : Predicat("circle",arite=1,fun=circleFunc),
     ...
     "etoiles_1":Predicat("etoiles",arite=1,fun=starFunc),
